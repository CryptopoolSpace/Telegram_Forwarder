...
class Config(object):
    ...
    # REQUIRED
    API_KEY = "1992440646:AAFZa6W6xS7xedq2ytoCARtPFXF6k10A970"  # API key obtained from BotFather
    OWNER_ID = "686960420"  # If you dont know, run the bot and do /id in your private chat with the bot

    # FOR AUTOMATICALLY FORWARDING MESSAGES
    FROM_CHATS = [-212686814]  # List of chat id's to forward messages from
    TO_CHATS = [-1001460142796]  # List of chat id's to forward messages to
